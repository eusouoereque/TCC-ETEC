        ...
        <form action="action/salvar_ticket.php" method="post">
            <div class="row d-flex justify-content-center">
                <div class="col-6 text-center">
                    <label class=" fs-3 text-center"><b>Empresa</b></label>
                    <select class="caixinhanav mb-4" style="width: 100%; height: 40px; font-size: 25px; border-radius: 10px; border: solid 2.5px; margin-bottom: 10px; padding: 4px; font-size: 1.3rem;" type='text' name="empresaticket" id="empresaticket"required>
                        <?php   
                            $result_empresa = "SELECT * FROM empresa WHERE ativo = 1 ORDER BY empresa";
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-6 text-center">
                    <label class=" fs-3 "><b>Tópico</b></label>
                    <select class="caixinhanav mb-4" name="topico" id="topico" style="width: 100%; height: 40px; font-size: 25px; border-radius: 10px; border: solid 2.5px; margin-bottom: 10px; padding: 4px; font-size: 1.3rem;" required>
                        <?php   
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-6 d-flex flex-column text-center">
                    ...
                    <select class="caixinhanav mb-4" name="subtopico" id="subtopico" style="width: 100%; height: 40px; font-size: 25px; border-radius: 10px; border: solid 2.5px; margin-bottom: 10px; padding: 4px; font-size: 1.3rem;" required>
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-6 text-center">
                    <label class="fs-3 "><b>Título</b></label>
            ...
            <div class="row d-flex justify-content-center">
                ...
                <div class="d-grid gap-2">
                        <button class="btn corbotao fs-4 mb-4" name="btnenviar" id="btnenviar" type="submit">Enviar Ticket</button>
                    </div>
                </div>
            </div>
        </form>
